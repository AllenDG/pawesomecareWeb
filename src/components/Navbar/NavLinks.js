...
const NavLinks = () => {
    return (
        <>
            ...
            <Link className="px-4 font-extrabold text-gray-500 hover:text-blue-900" smooth to="/get-appointment">
                Appointment
            </Link>
            <HashLink className="px-4 font-extrabold text-gray-500 hover:text-blue-900" to="/user-profile">
                Profile
            </HashLink>
