...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    // Compose the email using your template
    const emailParams = {
    ...
    emailjs.send('service_q0cz2qw', 'template_zej2iwo', emailParams, 'a5AHR55k92qdt4wUb')
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-8 bg-white-200">
        <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
          <form onSubmit={sendEmail}>
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-blue-500 hover:bg-blue-900 text-gray-100 p-3 rounded-lg w-full
          ...
          <div
            className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-gray-900 rounded-2xl">
            <div className="flex flex-col text-white">
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                <a href="https://www.facebook.com/profile.php?id=61550793555653" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
